...
private function pagination($con, $table, $pno, $n)
{
    ...
    if ($last != 1) {
        if ($pageno > 1) {
            $previous = "";
            $previous = $pageno - 1;
            $pagination .= "<li class='page-item'><a class='page-link' pn='".$previous."' href='#' style='color:#000000;'>Previous</a></li>";
        }
    ...
    public function storeCustomerOrderInvoice($orderdate,$cust_name,$ar_tqty,$ar_qty,$ar_price,$ar_pro_name,$sub_total,$gst,$discount,$net_total,$paid,$due,$payment_type)
    {
        ...
        if($invoice_no != null)
        {
            ...
            {
                // Here you are finding remaining quantity after giving the  customer share
...
//echo $obj->deleteRecord("categories","cid",5);
